defmodule Littlechat.OrganizerTest do
  ...
  describe "rooms" do
    ...
    @valid_attrs %{slug: "some slug", titile: "some titile"}
    @update_attrs %{slug: "some updated slug", titile: "some updated titile"}
    @invalid_attrs %{slug: nil, titile: nil}
    ...
    test "create_room/1 with valid data creates a room" do
      ...
      assert room.titile == "some titile"
    end
    ...
    test "update_room/2 with valid data updates the room" do
      ...
      assert room.titile == "some updated titile"
    end
